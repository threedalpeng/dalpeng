...
export const easeOutQuint: EasingFn = (t) => 1 + (t - 1) * (t - 1) * (t - 1) * (t - 1) * (t - 1);
...
export const easeInElastic: EasingFn = (t) =>
  t === 0
    ...
    : t === 1
      ? 1
      : -Math.pow(2, 10 * t - 10) * Math.sin((t * 10 - 10.75) * ELASTIC_PERIOD);
export const easeOutElastic: EasingFn = (t) =>
  t === 0 ? 0 : t === 1 ? 1 : Math.pow(2, -10 * t) * Math.sin((t * 10 - 0.75) * ELASTIC_PERIOD) + 1;
