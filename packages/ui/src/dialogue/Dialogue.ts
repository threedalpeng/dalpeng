...
export function Dialogue(controller: DialogueController): UIDescriptor<{ controller: DialogueController }> {
  return createUIDescriptor((props: { controller: DialogueController }) => {
    ...
    speakerEl.style.cssText = "font-weight: bold; font-size: 14px; color: #ffe082; display: none;";
    ...
    function renderChoices(line: DialogueLine, highlighted: number) {
      ...
      line.choices.forEach((choice, i) => {
        ...
        btn.style.cssText = [
          ...
          "border: 1px solid " + (isHighlighted ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.15)"),
          "border-radius: 4px",
          "padding: 6px 12px",
