...
export class Mat3 extends Float32Array {
  ...
  mul(m: Float32List) {
    // prettier-ignore
    return new Mat3([
      m[0] * this[0] + m[1] * this[3] + m[2] * this[6], m[0] * this[1] + m[1] * this[4] + m[2] * this[7], m[0] * this[2] + m[1] * this[5] + m[2] * this[8],
      m[3] * this[0] + m[4] * this[3] + m[5] * this[6], m[3] * this[1] + m[4] * this[4] + m[5] * this[7], m[3] * this[2] + m[4] * this[5] + m[5] * this[8],
      m[6] * this[0] + m[7] * this[3] + m[8] * this[6], m[6] * this[1] + m[7] * this[4] + m[8] * this[7], m[6] * this[2] + m[7] * this[5] + m[8] * this[8],
    ]);
  }
  ...
  inverse() {
    ...
    // prettier-ignore
    return new Mat3([
      (this[4] * this[8] - this[7] * this[5]) * s, (this[2] * this[7] - this[1] * this[8]) * s, (this[1] * this[5] - this[2] * this[4]) * s,
      (this[5] * this[6] - this[3] * this[8]) * s, (this[0] * this[8] - this[2] * this[6]) * s, (this[3] * this[2] - this[0] * this[5]) * s,
      (this[3] * this[7] - this[6] * this[4]) * s, (this[6] * this[1] - this[0] * this[7]) * s, (this[0] * this[4] - this[3] * this[1]) * s,
    ]);
  }
...
export class Mat4 extends Float32Array {
  ...
  mul(m: Float32List) {
    // prettier-ignore
    return new Mat4([
      m[0] * this[0] + m[1] * this[4] + m[2] * this[8] + m[3] * this[12],     m[0] * this[1] + m[1] * this[5] + m[2] * this[9] + m[3] * this[13],     m[0] * this[2] + m[1] * this[6] + m[2] * this[10] + m[3] * this[14],      m[0] * this[3] + m[1] * this[7] + m[2] * this[11] + m[3] * this[15],
      m[4] * this[0] + m[5] * this[4] + m[6] * this[8] + m[7] * this[12],     m[4] * this[1] + m[5] * this[5] + m[6] * this[9] + m[7] * this[13],     m[4] * this[2] + m[5] * this[6] + m[6] * this[10] + m[7] * this[14],      m[4] * this[3] + m[5] * this[7] + m[6] * this[11] + m[7] * this[15],
      m[8] * this[0] + m[9] * this[4] + m[10] * this[8] + m[11] * this[12],   m[8] * this[1] + m[9] * this[5] + m[10] * this[9] + m[11] * this[13],   m[8] * this[2] + m[9] * this[6] + m[10] * this[10] + m[11] * this[14],    m[8] * this[3] + m[9] * this[7] + m[10] * this[11] + m[11] * this[15],
      m[12] * this[0] + m[13] * this[4] + m[14] * this[8] + m[15] * this[12], m[12] * this[1] + m[13] * this[5] + m[14] * this[9] + m[15] * this[13], m[12] * this[2] + m[13] * this[6] + m[14] * this[10] + m[15] * this[14],  m[12] * this[3] + m[13] * this[7] + m[14] * this[11] + m[15] * this[15],
    ]);
  }
  ...
  det() {
    // prettier-ignore
    return (
      this[12] * this[9] * this[6] * this[3]  - this[8] * this[13] * this[6] * this[3]  - this[12] * this[5] * this[10] * this[3] + this[4] * this[13] * this[10] * this[3] +
